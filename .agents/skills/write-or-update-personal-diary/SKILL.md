...
# write-or-update-personal-diary — VAPE skill (shared agent wrapper)

The canonical instructions live in `.claude/skills/write-or-update-personal-diary/SKILL.md` (workspace-relative).
