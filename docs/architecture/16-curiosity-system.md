...
See also:
- [04-entity-model](04-entity-model.md) — FeelingEngine where curiosity/boredom signals feed in
- [15-sleep-system](15-sleep-system.md) — Topics persist across sleep, clarity levels maintained
