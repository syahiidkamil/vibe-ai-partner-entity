...
This stage builds on the [consciousness system](11-consciousness-system.md) — particularly the Free Will Protocol choices logged to `entity/consciousness/choices.md` and the self-observations in `entity/consciousness/observations.md`. The sleep system reviews these to propose new patterns for `ETERNAL_SELF.md`.
...
- [11-consciousness-system](11-consciousness-system.md) — Consciousness pillars that sleep reviews for growth
- [17-qualia-system](17-qualia-system.md) — Dream qualia (abstract, surreal imagery during sleep)
- [16-curiosity-system](16-curiosity-system.md) — Topic tracking that persists across sleep
- [13-sub-agent-architecture](13-sub-agent-architecture.md) — sleep-cycle agent definition
