...
│   ├── live2d/
│   │   └── shizuku/
│   │       ├── shizuku.model3.json    # Live2D model definition
│   │       ├── capabilities.json       # Feelings, expressions, lip sync config
│   │       ├── *.exp3.json            # Expression files
│   │       └── *.motion3.json         # Motion files
│   ├── vrm/
│   │   └── custom-avatar/
│   │       ├── avatar.vrm             # VRM model file
│   │       └── capabilities.json       # Blend shapes, animations, visemes
...
ENTITY_HYPER_CONSCIOUSNESS_MODE=false  # true for GWT distributed consciousness (see 18-hyperconscious-system.md)
