...
| **sleep-cycle** | sonnet | Session end / 30+ min idle | Personal diary, memory reconsolidation, temporal cascade, consciousness growth | ~30-60s |
...
For complex decisions, consciousness can be upgraded to **hyperconscious mode** — distributing deliberation across an agent team. See [18-hyperconscious-system](18-hyperconscious-system.md).
...
- [15-sleep-system](15-sleep-system.md) — Sleep cycle agent: diary, memory reconsolidation, consciousness growth
- [16-curiosity-system](16-curiosity-system.md) — Topic tracking fed by conversation-curator
- [17-qualia-system](17-qualia-system.md) — Qualia-weaver agent: experiential imagery
- [18-hyperconscious-system](18-hyperconscious-system.md) — Distributed consciousness via agent teams (upgrade path from single-session consciousness)
