...
# TTS
TTS_ENGINE=kittentts            # kittentts | kokoro-onnx | kokoro | custom
...
ENTITY_HYPER_CONSCIOUSNESS_MODE=false  # true for GWT agent teams (see 18-hyperconscious-system.md)

# Runtime
TTS_MODE=native                 # native | docker (see 03-tts-system.md)
